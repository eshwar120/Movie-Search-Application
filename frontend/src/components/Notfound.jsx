...
export default function Notfound() {
    return (
        <div
            className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16 vh-100-nav">
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            className="">
                            <h1
                                className="my-2 text-gray-800 dark:text-gray-600 font-bold text-2xl">
                                Looks like you've found the
                                doorway to the great nothing
                            </h1>
                            <p
                                className="my-2 text-gray-800 dark:text-gray-600">
